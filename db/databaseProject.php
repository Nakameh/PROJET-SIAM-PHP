...
class DataBaseProject
{
    ...
    private PDOStatement $prepareDeleteGame;
    private PDOStatement $prepareUpdateBoard;
    private PDOStatement $prepareSetIdWinner;
    ...
    public function __construct(string $path) {
        ...
        $this->prepareDeleteGame = $this->pdo->prepare("DELETE FROM Game WHERE id_Game = :id_Game");

        $this->prepareUpdateBoard = $this->pdo->prepare("UPDATE Game SET game_board_Game = :game_board_Game
                WHERE id_Game = :id_Game");

        $this->prepareSetIdWinner = $this->pdo->prepare("UPDATE Game SET id_user_winner = :id_user_winner
                WHERE id_Game = :id_Game");
    ...
    public function deleteGame(int $id_Game) {
        $this->prepareDeleteGame->execute([":id_Game" => $id_Game]);
    }

    public function updateBoard(int $id_game, string $board) {
        $this->prepareUpdateBoard->execute(["id_Game" => $id_game, "game_board_Game" => $board]);
    }

    public function setIdWinner(int $id_Game, int $id_user_winner) {
        $this->prepareSetIdWinner->execute([":id_Game" => $id_Game, ":id_user_winner" => $id_user_winner]);
    }
